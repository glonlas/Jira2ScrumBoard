/**
 * CSV Parser
 * @module story/views/index/classes/csvparser
 * @requires base
 */
var
...
CSVParser = function(config)
{
	CSVParser.superclass.constructor.apply(this, arguments);
};

Y.namespace(NS).CSVParser = Y.extend(CSVParser, Y.Base, {
